...
It is similar to QBall's AutoMPD, but simpler and only used for testing
currently.
'''
...
try:
    ...
    print('Install mutagen with: sudo pip install mutagen')
    sys.exit(-1)
...
def create_music_directory(music_dir, database):
    ...
    for song in database:
        ...
        audio = mutagen.File(new_filename)
